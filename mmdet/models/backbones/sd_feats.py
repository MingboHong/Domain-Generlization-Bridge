...
# # ------------------------------------------------------------------------------
# import sys
# sys.path.append("/root/autodl-tmp/mmdetection/mmdet/models/backbones/ODISE") 
# import logging
...
# from mmdet.models.backbones.ODISE.odise.checkpoint.odise_checkpointer import LdmCheckpointer
# from mmdet.models.backbones.ODISE.odise.modeling.meta_arch.clip import ClipAdapter
# from mmdet.models.backbones.ODISE.odise.utils.file_io import PathManager

# from mmdet.models.backbones.ODISE.odise.modeling.diffusion import GaussianDiffusion, create_gaussian_diffusion
# import timm
# from mmdet.models.backbones.ODISE.odise.modeling.preprocess import batched_input_to_device
# from mmdet.models.backbones.ODISE.odise.modeling.meta_arch.helper import FeatureExtractor
# from mmdet.models.backbones.ODISE.feat_extractor import FeatureExtractorBackbone
...
#         learnable_time_embed=True,
#         num_timesteps=1,):
#         super(SD_BackBone, self).__init__()
#         self.feature_extractor = FeatureExtractorBackbone(
#             feature_extractor = LdmImplicitCaptionerExtractor(encoder_block_indices=encoder_block_indices,
#             unet_block_indices=unet_block_indices,
#             decoder_block_indices=decoder_block_indices,
#             steps=steps,
...
# #     # 生成测试输入数据
# #     test_input = {
# #         "img": torch.randn(1, 3, 512, 512),  # 1 张 224x224 RGB 图片
# #     }
    
    
    
# #     feature_extractor=FeatureExtractorBackbone(
