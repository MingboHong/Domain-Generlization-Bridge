...
class PositionalLinear(nn.Module):
    def __init__(self, in_features, out_features, seq_len=77, bias=True,**kwargs):
        super().__init__()
...
class DiffusionExtractorBase(nn.Module):
    """
    ...
    def __init__(self, config, device):
        ...
        self.clip_project = PositionalLinear(self.clip.dim_latent, 1024, 77)
